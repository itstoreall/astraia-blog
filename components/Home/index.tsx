      ...
      <div className={s.home}>
        <article className={`${s.homeContent} ${s[currentTheme]}`}>
          ...
          <p className={s.paragraph}>
            ...
            помогут вам на пути к гармонии, радости и саморазвитию. Блог Astraia
            создан с целью помочь людям искать глубинное понимание себя, своего
            места в мире и найти путь к росту и развитию своей души. Мы верим,
            что каждый из нас обладает внутренним потенциалом и способностью к
            преображению. Астрая поможет раскрыть этот потенциал.
          </p>
